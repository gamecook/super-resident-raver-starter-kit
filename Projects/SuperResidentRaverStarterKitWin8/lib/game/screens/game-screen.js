    ...
    .defines(function () {
        ...
        GameScreen = ig.Game.extend({
            ...
            alignButtons:function () {
                ...
                var controlsY = 370;
                ig.input.registerHitArea("left", 10, controlsY, 100, 100, "touch");
                ig.input.registerHitArea("right", 120, controlsY, 100, 100, "touch");
                ig.input.registerHitArea("jump", 580, controlsY, 100, 100, "touch");
                ig.input.registerHitArea("shoot", 690, controlsY, 100, 100, "touch");
            ...
            draw:function () {
                ...
                if (ig.input.touchType == "touch") {
                    //console.log("touch type", ig.input.touchType);

                    //ig.input.draw();
                    //TODO need to test if game is on touch screen
                    this.textures.drawFrame("touch-button-0.png", 10, 370);
                    this.textures.drawFrame("touch-button-1.png", 120, 370);
                    this.textures.drawFrame("touch-button-2.png", 580, 370);
                    this.textures.drawFrame("touch-button-3.png", 690, 370);
                }
            },
