    ...
    .defines(function () {
        ...
        GameScreen = ig.Game.extend({
            ...
            alignButtons:function () {
                ...
                var controlsY = 350;
                ig.input.registerHitArea("left", 10, controlsY, 131, 96, "touch");
                ig.input.registerHitArea("right", 160, controlsY, 131, 96, "touch");
                ig.input.registerHitArea("shoot", 580, controlsY + 10, 90, 90, "touch");
                ig.input.registerHitArea("jump", 690, controlsY + 10, 90, 90, "touch");
                ig.input.registerHitArea("continue", 0, 0, ig.system.width, ig.system.height);
            ...
            draw:function () {
                ...
                if (ig.input.touchType == "touch") {
                    var tmpY = 350;
                    this.textures.drawFrame("touch-button-0.png", 10, tmpY);
                    this.textures.drawFrame("touch-button-1.png", 160, tmpY);
                    this.textures.drawFrame("touch-button-2.png", 580, tmpY + 10);
                    this.textures.drawFrame("touch-button-3.png", 690, tmpY + 10);
                }
            },
